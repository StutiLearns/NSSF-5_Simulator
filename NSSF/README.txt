...
From DockerHub:
    docker stop uploader (for mysql-container, automate too)
    docker rmi deepikapavundoss/nssf-sqldb (for deepikapavundoss/nssf1-request, deepikapavundoss/nssf1-host)
